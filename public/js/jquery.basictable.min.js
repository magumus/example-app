...
!(function (t) {
    (t.fn.basictable = function (a) {
        var e = function (a, e) {
            ...
            r = function (a, e) {
                e.forceResponsive
                    ? (null !== e.breakpoint && t(window).width() <= e.breakpoint) || (null !== e.containerBreakpoint && a.parent().width() <= e.containerBreakpoint)
                        ? i(a, e)
                        : o(a, e)
                    : a.removeClass("bt").outerWidth() > a.parent().width()
                    ? i(a, e)
                    : o(a, e);
            },
            i = function (t, a) {
            ...
            s = function (a, e) {
                var n;
                a.removeClass("bt bt--no-header"),
                    a.find("td").removeAttr("data-th"),
                    e.tableWrap && a.unwrap(),
                    e.contentWrap &&
                        ((n = a),
                        t.each(n.find("td"), function () {
                            var a = t(this),
        ...
        this.each(function () {
            ...
            null === d.breakpoint && null === d.containerBreakpoint && (d.breakpoint = 568),
                n.data("basictable", d),
                e(n, n.data("basictable")),
                d.noResize ||
                    (r(n, n.data("basictable")),
